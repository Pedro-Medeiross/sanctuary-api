...
from app.routes.tickets.dashboard import router as tickets_dashboard_router
from app.routes.tickets.bot import router as tickets_bot_router
from app.routes.tickets import ws_router as tickets_ws_router
...
# Health check
@app.get("/health")
async def health_check(app_user: str = Depends(verify_app_auth)):
...
app.include_router(tickets_dashboard_router)
app.include_router(tickets_bot_router)
